...
export const PHASE_1 = [
  ...
  {
    key: "human-review-v1",
    label: "Human Review / External Handoff",
    agent: null,
    aliases: ["human_review_v1"],
    description: "Human-owned review that completes the local v1 boundary and prepares a future isolated Unit 11 handoff.",
    checkpoints: [],
    reviewVersion: "v1",
  },
];
...
export const PHASE_2 = [
  ...
  },
  {
    ...
    label: "Human Review / External Handoff",
    agent: null,
    aliases: ["human_review_v2"],
    description: "Human-owned review that completes the local v2 boundary and prepares a future isolated Unit 11 handoff.",
    checkpoints: [],
    reviewVersion: "v2",
  },
];
