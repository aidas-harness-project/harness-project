...
Do not call `finalize-stage` yourself. Return only after every gate below is
clear; the orchestrator owns the successful `finalize-stage
... policy_clause_processing` call so the T13 attempt boundary has exactly one
owner.
