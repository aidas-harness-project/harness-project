...
|---|---|---|---|
| 1 | Case Intake | (orchestrator + `intake_case.py`) | D2-gated `_source_ledger.json`; every PDF starts `segmentation_status: pending_review` for a human bundle decision. Records under `intake` |
